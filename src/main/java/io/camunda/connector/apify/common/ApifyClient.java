...
public class ApifyClient implements AutoCloseable {
     ...
     * @return ResponseResult containing the deletion confirmation, or a 404 result if already deleted
     * @throws ApifyClientException if the request fails with a non-404 error
     * @throws IOException if the request fails at the network level
     */
