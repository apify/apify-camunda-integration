...
/**
 * Integration tests for ApifyInboundExecutable that test webhook creation and deletion
...
public class ApifyInboundExecutableIntegrationTest {
    ...
    /**
     * Tests that the deactivate() method successfully deletes the webhook from Apify.
     */
    @Test
